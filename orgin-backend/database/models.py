...
class OriginRegistry(Base):
    ...
    password_hash = Column(String, nullable=False) # Store securely hashed passwords
    secret_key = Column(String, nullable=False) # Dedicated secret key for cryptographic MAC
